	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="champs-persos">
			<?php
				...
				$nationalite = get_post_meta($post->ID, 'nationalite', true);
				$genre = get_post_meta($post->ID, 'genre', true);
				$critique = get_post_meta($post->ID, 'critique', true);
			?>
			<?php if(false === empty($realisateur)): ?>
				<span class="champs-persos-item">
				<i class=”champs-persos-label”>réalisateur(s) : </i>
				<?php echo $realisateur ?><br/></span>
			<?php endif; ?>
			<?php if(false === empty($acteurs)): ?>
				<span class="champs-persos-item">
				<i class=”champs-persos-label”>interprètes : </i>
				<?php echo $acteurs ?><br/></span>
			<?php endif; ?>
			<?php if(false === empty($annee)): ?>
				<span class="champs-persos-item">
				<i class=”champs-persos-label”>année : </i>
				<?php echo $annee ?><br/></span>
			<?php endif; ?>
			<?php if(false === empty($duree)): ?>
				<span class="champs-persos-item">
				<i class=”champs-persos-label”>durée : </i>
				<?php echo $duree ?><br/></span>
			<?php endif; ?>
			<?php if(false === empty($nationalite)): ?>
				<span class="champs-persos-item">
				<i class=”champs-persos-label”>nationalité(s) : </i>
				<?php echo $nationalite ?><br/></span>
			<?php endif; ?>
			<?php if(false === empty($genre)): ?>
				<span class="champs-persos-item">
				<i class=”champs-persos-label”>genre(s) : </i>
				<?php echo $genre ?><br/></span>
			<?php endif; ?>
			<?php if(false === empty($critique)): ?>
				<span class="champs-persos-item">
				<i class=”champs-persos-label”>prix : </i>
				<?php echo $critique ?><br/></span>
			<?php endif; ?>
		</div> <!-- .champs-perso -->
