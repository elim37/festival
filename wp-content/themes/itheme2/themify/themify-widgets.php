...
class Themify_Social_Links extends WP_Widget {
	...
	function Themify_Social_Links() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'themify-social-links', 'description' => __('A list of links with icons.', 'themify') );
	...
	function form( $instance ) {
		...
		<p>
			<?php echo sprintf(__('Manage links at <a href="%s">Themify</a> > Settings > Social Links.', 'themify'), admin_url('admin.php?page=themify#setting')); ?>
		</p>
		<?php
	}
}
