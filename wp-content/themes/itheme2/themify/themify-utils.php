...
/***************************************************************************/	
	...
	function themify_page() {
        ...
        <p id="theme-title"><?php echo $theme->display('Name'); ?> <em><?php echo $theme->display('Version'); ?> (<a href="http://themify.me/logs/<?php echo '' != $theme->display('Template')? $theme->display('Template') : strtolower($theme->display('Name')); ?>-changelogs" class="themify_changelogs" target="_blank"><?php _e('changelogs', 'themify'); ?></a>)</em></p>
...
function themify_https_esc($url = ''){
	if( isset($_SERVER['HTTPS']) && (0 != strcasecmp('off', $_SERVER['HTTPS'])) ){
...
function themify_presstrends_theme() {
	...
	if ( !$data || $data == '' ) {
		...
		$posts_with_comments = $wpdb->get_var( $wpdb->prepare("SELECT COUNT(*) FROM %s WHERE post_type='post' AND comment_count > %d", $wpdb->posts, 0) );
		$data = array(
